package com.yoxnet.linearDisaster.bean;
...
public class LinearDisaster implements Serializable {
    ...
    /**将本身对象转换成vo对象返回*/
	public DisasterVO toCommandVO(){
		DisasterVO commandVo = new DisasterVO();
		try {
	...
	public LinearDisaster fromCommandVo(DisasterVO commandVo){
		try {
